...
final class PlaybackViewController: UIViewController, HKPictureInPicureController {
    ...
    private func rtmpStatusHandler(_ notification: Notification) {
        ...
        case RTMPConnection.Code.connectFailed.rawValue, RTMPConnection.Code.connectClosed.rawValue:
            ...
            rtmpConnection.connect("rtmp://vp-push-ed1.gvideo.co/in/67674b?10e42ad17cff46bfa0118f5043180884")
     //       "rtmp://vp-push-ed1.gvideo.co/in/67674b?10e42ad17cff46bfa0118f5043180884"
            retryCount += 1
        default:
            break
        }

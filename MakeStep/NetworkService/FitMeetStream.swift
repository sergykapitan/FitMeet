...
class FitMeetStream {
    ...
    public func getOffNotAuthBroadcast(page: Int) -> AnyPublisher<BroadcastList, DifferentError> {
        return AF.request(Constants.apiEndpoint + "/stream/broadcasts?page=\(page)&take=12&sort=viewersCount&status=OFFLINE&type=STANDARD_VOD", method: .get, encoding: JSONEncoding.default,interceptor: Interceptor(interceptors: [AuthInterceptor()]))
                 .validate(statusCode: 200..<300)
                 .validate(contentType: ["application/json"])
                 .publishDecodable(type: BroadcastList.self)
                 .value()
    ...
    public func getBroadcastN2(page: Int) -> AnyPublisher<BroadcastList, DifferentError> {
        return AF.request(Constants.apiEndpoint + "/stream/broadcasts?order=ASC&page=\(page)&take=10&sort=status&statusSort=ONLINE&statusSort=FINISHED&statusSort=OFFLINE&statusSort=PLANNED&statusSort=WAIT_FOR_APPROVE&statusSort=BANNED",
                          method: .get, encoding: JSONEncoding.default,interceptor: Interceptor(interceptors: [AuthInterceptor()]))
                 .validate(statusCode: 200..<300)
                 .validate(contentType: ["application/json"])
                 .publishDecodable(type: BroadcastList.self)
   ...
   //&type=\(type)
    ...
    public func getBroadcastinLive(status: BroadcastStatus) -> AnyPublisher<BroadcastList, DifferentError> {
        return AF.request(Constants.apiEndpoint + "/stream/broadcasts?take=10&status=\(status.description)", method: .get, encoding: JSONEncoding.default,interceptor: Interceptor(interceptors: [AuthInterceptor()]))
                 .validate(statusCode: 200..<300)
                 .validate(contentType: ["application/json"])
                 .publishDecodable(type: BroadcastList.self)
                 .value()
                 .print("getBroadcastLive")
                 .mapError { DifferentError.alamofire(wrapped: $0) }
                 .eraseToAnyPublisher()
        
           }
    public func getBroadcastinRecent(status: BroadcastStatus) -> AnyPublisher<BroadcastList, DifferentError> {
        return AF.request(Constants.apiEndpoint + "/stream/broadcasts?sort=id&order=DESC&status=\(status.description)&take=10", method: .get, encoding: JSONEncoding.default,interceptor: Interceptor(interceptors: [AuthInterceptor()]))
                 .validate(statusCode: 200..<300)
                 .validate(contentType: ["application/json"])
                 .publishDecodable(type: BroadcastList.self)
                 .value()
                 .print("getBroadcastLive333")
                 .mapError { DifferentError.alamofire(wrapped: $0) }
                 .eraseToAnyPublisher()
    ...
    public func getAllBroadcastPrivate(name: String) -> AnyPublisher<BroadcastList, DifferentError> {
        return AF.request(Constants.apiEndpoint + "/stream/broadcasts/private?take=200&isPublished=true&sort=followersCount&nameLike=\(name)", method: .get, encoding: JSONEncoding.default,interceptor: Interceptor(interceptors: [AuthInterceptor()]))
                 .validate(statusCode: 200..<300)
                 .validate(contentType: ["application/json"])
                 .publishDecodable(type: BroadcastList.self)
                 .value()
    ...
    public func getAllBroadcastNotAuth(name: String) -> AnyPublisher<BroadcastList, DifferentError> {
        return AF.request(Constants.apiEndpoint + "/stream/broadcasts?take=200&isPublished=true&nameLike=\(name)", method: .get, encoding: JSONEncoding.default,interceptor: Interceptor(interceptors: [AuthInterceptor()]))
                 .validate(statusCode: 200..<300)
                 .validate(contentType: ["application/json"])
                 .publishDecodable(type: BroadcastList.self)
                 .value()
    ...
    public func getBroadcastCategoryId(categoryId: Int,page: Int) -> AnyPublisher<BroadcastList, DifferentError> {
        return AF.request(Constants.apiEndpoint + "/stream/broadcasts/private?page=\(page)&isPublished=true&take=10&broadcastCategoryId=\(categoryId)", method: .get, encoding: JSONEncoding.default,interceptor: Interceptor(interceptors: [AuthInterceptor()]))
                 .validate(statusCode: 200..<300)
                 .validate(contentType: ["application/json"])
                 .publishDecodable(type: BroadcastList.self)
                 .value()
    ...
    public func getBroadcastCategoryIdNotAuth(categoryId: Int) -> AnyPublisher<BroadcastList, DifferentError> {
        return AF.request(Constants.apiEndpoint + "/stream/broadcasts?take=200&isPublished=true&broadcastCategoryId=\(categoryId)", method: .get, encoding: JSONEncoding.default,interceptor: Interceptor(interceptors: [AuthInterceptor()]))
                 .validate(statusCode: 200..<300)
                 .validate(contentType: ["application/json"])
                 .publishDecodable(type: BroadcastList.self)
                 .value()
...
//?privateUrlKey=ca3bb948-19a0-4ec3-957a-bb02b100076c
    ...
    public func getPrivateBroadcastId(id: String) -> AnyPublisher< BroadcastResponce, DifferentError> {
        return AF.request(Constants.apiEndpoint + "/stream/broadcasts/private/\(id)", method: .get, encoding: JSONEncoding.default,interceptor: Interceptor(interceptors: [AuthInterceptor()]))
                 .validate(statusCode: 200..<300)
                 .validate(contentType: ["application/json"])
                 .publishDecodable(type: BroadcastResponce.self)
                 .value()

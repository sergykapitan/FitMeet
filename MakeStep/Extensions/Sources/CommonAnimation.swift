...
enum EasingType: String {
    ...
    var rawValue: String {
        ...
        case .easeInOut: return CAMediaTimingFunctionName.easeInEaseOut.rawValue//.EaseInEaseOut
        case .defaultEasing: return CAMediaTimingFunctionName.linear.rawValue

...
open class IMProgressHUD: UIView {
    ...
    private func configure() {
        ...
        if let effect = configuration.backgroundEffect {
            containerView.effect = nil//effect
            containerView.backgroundColor = nil
        } else {
            containerView.effect = nil
            containerView.backgroundColor = .red//configuration.backgroundColor
        }
...
public extension IMProgressHUD {
    ...
    struct Configuration {
        ...
        /// The container's background color.
        /// The default value is `#484B55`.
        public var backgroundColor: UIColor = .red // #colorLiteral(red: 0.2823529412, green: 0.2941176471, blue: 0.3333333333, alpha: 1)

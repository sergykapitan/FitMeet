...
//    }()
    ...
    func createCardViewLayer() {
       ...
       // addSubview(cardView)
        ...
        segmentControll.anchor(top: cardView.topAnchor, left: cardView.leftAnchor, paddingTop: 120, paddingLeft: 16, height: 30)
...
//        buttonstartStream.centerX(inView: imagePromo)
        ...
        selfView.anchor(top: segmentControll.bottomAnchor, left: cardView.leftAnchor, right: cardView.rightAnchor, bottom: cardView.bottomAnchor, paddingTop: 0, paddingLeft: 0, paddingRight: 0, paddingBottom: 0)

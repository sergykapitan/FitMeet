    ...
    */
    ...
    private func drawThumbSlider(in rect: CGRect, context: CGContext, x: CGFloat) {
        ...
        let ellipseRect = CGRect(
            x: sliderX,
            y: getSlidingTrackVerticalOffset() - thumbSliderRadius + 7,
        ...
        context.setStrokeColor(UIColor(red: 0.231, green: 0.345, blue: 0.643, alpha: 1).cgColor)
    ...
    private func drawBubbleValue(in rect: CGRect, context: CGContext, x: CGFloat) {
       ...
       // context.setFillColor(bubbleOutlineColor.cgColor )
    ...
    private func getDisplayValue() -> Int {
        print((actualFractionalValue / slidingInterval) * slidingInterval)
